    ...
    <div class="max-w-5xl mx-auto space-y-6">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <h2 class="h3 text-emerald-900 mb-0">Create Student Account</h2>
                <p class="text-slate-600 mb-0">Fill in student details. They can log in immediately with this email and password.</p>
            </div>
        ...
        <div class="soft-card p-5">
            <form method="POST" action="{{ route('teacher.students.store') }}" class="space-y-4">
                ...
                <div class="d-flex gap-3 mt-3">
                    <button type="submit" class="btn btn-success rounded-pill px-4 py-2">Create Student</button>
